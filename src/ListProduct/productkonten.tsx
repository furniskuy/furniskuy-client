    ...
    <>
      <div>
        <div className={styles["productHeader"]}>
          <div className={styles["PHKiri"]}>
            ...
            <div className={styles["Kategori"]}>
              <div
                className={ styles [
                  halaman === 1 ? "statusSelected" : "statusNotSelected"]
                }
              ...
              <div
                className={styles [
                  halaman === 2 ? "statusSelected" : "statusNotSelected"]
                }
          ...
          <div className={styles["LihatSemua"]}>
            <div
              className={styles [halaman === 3 ? "statusSelected" : "statusNotSelected"]}
        ...
        <div className={styles["BarKategoriProduct"]}>
          <div
            className={styles [kategori === 1 ? "statusSelected" : "statusNotSelected"]}
          ...
          <div
            className={styles [kategori === 2 ? "statusSelected" : "statusNotSelected"]}
          ...
          <div
            className={styles [kategori === 3 ? "statusSelected" : "statusNotSelected"]}
          ...
          <div
            className={styles [kategori === 4 ? "statusSelected" : "statusNotSelected"]}
          ...
          <div
            className={styles [kategori === 5 ? "statusSelected" : "statusNotSelected"]}
          ...
          <div
            className={styles [kategori === 6 ? "statusSelected" : "statusNotSelected"]}
        ...
        <div className={styles ["daftarProduk"]}>
          <div className={styles ["cardProduct"]}>
            ...
            <div className={styles["namaProduk"]}>
              ...
              <img src={tandapanah} alt="ahhh" className={styles["tandapanah"]} />
            </div>
          </div>
