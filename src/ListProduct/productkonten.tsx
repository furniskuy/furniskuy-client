    ...
    <>
      <div>
        ...
        <div className="BarKategoriProduct">
          <div
            className={kategori === 1 ? "statusSelected" : "statusNotSelected"}
          ...
          <div
            className={kategori === 2 ? "statusSelected" : "statusNotSelected"}
          ...
          <div
            className={kategori === 3 ? "statusSelected" : "statusNotSelected"}
          ...
          <div
            className={kategori === 4 ? "statusSelected" : "statusNotSelected"}
          ...
          <div
            className={kategori === 5 ? "statusSelected" : "statusNotSelected"}
          ...
          <div
            className={kategori === 6 ? "statusSelected" : "statusNotSelected"}
